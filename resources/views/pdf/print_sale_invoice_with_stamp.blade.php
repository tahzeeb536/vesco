			        ...
			        <table width="100%" border="0" style="border-collapse:collapse" cellpadding="3" cellspacing="0">
    					...
    					<td width="33.33%" style="padding:3px 0 0 0;">
    						...
    						<div class="party">
    							...
    							<strong contenteditable="true">Phone: </strong> {{ $saleInvoice->customer->phone }}<span></span>
    						</div>
    					</td>
    				        ...
    				        <table class="table new_one" width="100%" border="1" cellpadding="4" style="background-color: #fff; border-top:0;">
                    			...
                    			<tbody>
                                    ...
                                    <tr id="row_{{$key+1}}" class="item">
                                        ...
                                        <td contenteditable="true">{{ $item->variant->product->article_number }}</td>
                                        <td><input class="item-name" data-id="1" type="text" style="border:none; padding:0px; margin:0px; font-size: 14px; width:100%" value="{{ $item->variant->product->name }}" /></td>
                                        <td><input type="text" style="border:none; padding:0px; margin:0px; font-size: 14px; width:100%"  value="{{ $item->variant->size->name }}" /></td>
                            ...
                            <td class="footer_content" align="center" height="100">
                                <div id="footer_content" style="padding: 0 0 10px 0;">
                                    <img src="{{ asset('images/logo-for-invoice.png') }}" alt="no image preview" width="600" height="">
                                        ...
                                        <div class="container"><img style="position: absolute"  height="120" id="dragable" src="{{ asset('images/ves_stamp_transparent.png') }}" alt=""></div>
