...
class GrnPolicy
{
    ...
    {
        return $user->can('delete_any_grn');
    }
    ...
    {
        return $user->can('force_delete_grn');
    }
    ...
    {
        return $user->can('force_delete_any_grn');
    }
    ...
    {
        return $user->can('restore_any_grn');
    }
